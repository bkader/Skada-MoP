...
L["%s's healing"] = "%s的治療"
L["%s's healed targets"] = "%s治療的玩家"
L["actor heal spells"] = function(n1, n2) return ((not n2 or n1 == n2) and "%s的治療法術" or "%s對%s的治療"):format(n1, n2) end
L["HPS"] = "每秒治療"
L["sHPS"] = "每秒治療 (子模塊)"
...
L["Overheal"] = "過量治療"
L["Overhealing"] = "過量治療"
L["%s's overheal targets"] = "%s過量治療的玩家"
L["actor overheal spells"] = function(n1, n2) return ((not n2 or n1 == n2) and "%s的過量治療法術" or "%s對%s的過量治療"):format(n1, n2) end
L["Absorbs"] = "吸收量"
L["Target List"] = "目標清單"
L["Spell List"] = "法术列表"
L["%s's absorbed targets"] = "%s的吸收玩家"
L["actor absorb spells"] = function(n1, n2) return ((not n2 or n1 == n2) and "%s的吸收法術" or "%s對%s的吸收"):format(n1, n2) end
L["APS"] = "每秒吸收"
L["sAPS"] = "每秒吸收 (子模塊)"
L["Absorbs and Healing"] = "吸收和治療"
L["%s's absorbed and healed targets"] = "%s的吸收和治療玩家"
L["actor absorb and heal spells"] = function(n1, n2) return ((not n2 or n1 == n2) and "%s的吸收和治療法術" or "%s對%s的吸收和治療"):format(n1, n2) end
L["%s's heal sources"] = "%s的治療源"
...
L["Damage Done"] = "總傷害"
L["actor damage"] = function(n1, n2) return ((not n2 or n1 == n2) and "%s的傷害" or "%s的傷害於%s"):format(n1, n2) end
L["%s's <%s> damage"] = "%s的<%s>傷害"
...
L["%s's dispel spells"] = "%s的驅散法術"
L["%s's dispelled spells"] = "%s的已驅散法術"
L["%s's dispelled targets"] = "%s的已驅散目標"
-- interrupts module lines --
L["Interrupt spells"] = "打斷法術"
L["%s's interrupt spells"] = "%s的打斷法術"
L["%s's interrupted spells"] = "%s的已打斷法術"
L["%s's interrupted targets"] = "%s的已打斷目標"
...
L["%s's gained %s"] = "%s的獲得%s"
-- Parry module lines --
L["Parry-Haste"] = "招架-急速"
L["%s's parry targets"] = "%s的招架目標"
...
L["Resurrects"] = "復活"
L["%s's resurrect targets"] = "%s的複活目標"
