...
L["opt_isusingclasscolors_desc"] = "Цвета класса:\n\124cFFF58CBAKader\124r - 5.71М (21.7К)\n\nБез:\nKader - 5.71М (21.7К)"
...
L["actor heal spells"] = function(n1, n2) return ((not n2 or n1 == n2) and "%s - Исцеляющие заклинания" or "%2$s - Исцеление от %1$s"):format(n1, n2) end
L["HPS"] = "ИВС"
...
L["%s's overheal targets"] = "%s - Избыточно исцеленные цели"
L["actor overheal spells"] = function(n1, n2) return ((not n2 or n1 == n2) and "%s - Заклинания избыточного исцеления" or "%2$s - Избыточное исцеление от %1$s"):format(n1, n2) end
L["Absorbs"] = "Поглощение"
L["Target List"] = "Список целей"
L["Spell List"] = "Список заклинаний"
L["%s's absorbed targets"] = "%s - Поглощено цели"
L["actor absorb spells"] = function(n1, n2) return ((not n2 or n1 == n2) and "%s - Заклинания поглощения" or "%2$s - Поглощение от %1$s"):format(n1, n2) end
L["APS"] = "ПВС"
...
L["actor absorb and heal spells"] = function(n1, n2) return ((not n2 or n1 == n2) and "%s - Заклинания поглощения и исцеления" or "%2$s - Поглощение и исцеление от %1$s"):format(n1, n2) end
L["%s's heal sources"] = "%s - Источники исцеления"
...
L["%s's buffs"] = "%s - Бафы"
L["Debuffs"] = "Дебафы"
L["actor debuffs"] = function(n1, n2) return ((not n2 or n1 == n2) and "%s - Дебафы" or "%s - Дебафы по %s"):format(n1, n2) end
...
L["actor damage"] = function(n1, n2) return ((not n2 or n1 == n2) and "%s - Урон" or "%2$s - Урон от %1$s"):format(n1, n2) end
...
L["Mana gained spells"] = "Заклинания получения Мана"
L["Rage gained spells"] = "Заклинания получения Ярость"
L["Energy gained spells"] = "Заклинания получения Энергия"
L["Runic Power gained spells"] = "Заклинания получения Сила рун"
